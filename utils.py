...
def plot_timeseries_causal_mask(targets, outputs, mask, act_labels, act_preds):
    """
    targets and outputs are of shape (bsize, num_patch, nvars, patch_len)
    targets are the original timeseries (not masked)
    outputs are the predicted timeseries (masked)
    ...
    return plot_timeseries(inputs, targets, outputs, act_labels=act_labels, act_preds=act_preds)
